...
class MatchForm(forms.ModelForm):
    class Meta:
        ...
        fields = ["date", "time", "location_name", "location_google_maps_embed_url", "max_players"]
    ...
    def clean_max_players(self):
        ...
        if self.instance.pk:  # editing existing match
            joined_count = self.instance.participation_set.filter(status='joined', removed=False, is_no_show=False).count()
